...
int ObjFileModel::loadfile(char* fname)
{
	...
	if (pFile == NULL) { OutputDebugString(L"Failed to open model file "); OutputDebugStringA(fname); OutputDebugStringA("\n"); return 0; }
	...
	OutputDebugString(L"Loaded model file "); OutputDebugStringA(fname); OutputDebugStringA("\n");
